...
def finetune_model(cell_type, lr, layer_size, checkpoint_dir):
    cmd = [
        "python3", 
        "finetune/test_finetune_model_tanh.py",
        "--cell_type", cell_type,
        "--lr", str(lr),
    ...
    subprocess.run(cmd)
    out_file = f'/g/data/zk16/zelun/z_li_hon/wonglab_github/enformer-pytorch-fine-tune/finetune/best_result/{cell_type}/Tanh_test_result.txt'
...
class EnformerFineTuneModel(pl.LightningModule):
    ...
    def on_test_epoch_end(self) -> None:
        ...
        file_path = f"/g/data/zk16/zelun/z_li_hon/wonglab_github/enformer-pytorch-fine-tune/finetune/best_result/{self.cell_type}/Tanh_AUROC_PLOT.csv"
...
if __name__ == '__main__':
    ...
    file_name = f"finetune/best_result/{cell_type}/Tanh_final_{cell_type}_fine_tune_best_result_with_activation_run_final.txt"
