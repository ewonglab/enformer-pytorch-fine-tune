#!/bin/bash 
#PBS -N Enformer_Binary_Prediction_fine_tune_exe_endo
#PBS -P zk16
#PBS -q gpuvolta 
#PBS -l jobfs=128GB
...
python3 finetune/fine_tune_tidy.py --cell_type='exe_endo' > "/g/data/zk16/zelun/z_li_hon/wonglab_github/enformer-pytorch-fine-tune/finetune/best_result/exe_endo/final_exe_endo_test_result.txt"
