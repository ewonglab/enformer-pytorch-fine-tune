#!/bin/bash 
#PBS -N Enformer_Binary_Prediction_fine_tune_somitic_meso
#PBS -P zk16
#PBS -q gpuvolta 
#PBS -l jobfs=128GB
...
python3 finetune/fine_tune_tidy.py --cell_type='somitic_meso' > "/g/data/zk16/zelun/z_li_hon/wonglab_github/enformer-pytorch-fine-tune/finetune/best_result/somitic_meso/final_somitic_meso_test_result.txt"
