#!/bin/bash 
#PBS -N Enformer_Binary_Prediction_fine_tune_mid_hindbrain
#PBS -P zk16
#PBS -q gpuvolta 
#PBS -l jobfs=128GB
...
python3 finetune/fine_tune_tidy.py --cell_type='mid_hindbrain' > "/g/data/zk16/zelun/z_li_hon/wonglab_github/enformer-pytorch-fine-tune/finetune/best_result/mid_hindbrain/final_mid_hindbrain_test_result.txt"
